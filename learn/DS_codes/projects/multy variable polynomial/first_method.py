...
<<<<<<< HEAD:learn/DS_codes/projects/multy variable polynomial/main.py
...
>>>>>>> c2838e332812aa1106b6a716f8dadcfb9ad647d4:learn/DS_codes/projects/multy variable polynomial/first_method.py
    print(x.print(a))
    print(x.print(b))