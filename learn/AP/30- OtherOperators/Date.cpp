...
Date::Date(int intDate) //Convert 19861024 to a valid Date
{
    int d = intDate % 100;
    intDate /= 100;
    int m = intDate % 100;
...
void Date::operator()(int m, int d, int y)
{
    setDate(m, d, y);
}
...
Date::operator string() const
{
    static string monthName[13] = {"", "January", "February",
      "March", "April", "May", "June", "July", "August",
      "September", "October", "November", "December"};
    string s = monthName[month] + " " + to_string(day) + ", " + to_string(year);
    return s;
}*/
...
Date::operator const char *() const
{
    static string monthName[13] = {"", "January", "February",
      ...
      "September", "October", "November", "December"};
    static string s;
    s = monthName[month] + " " + to_string(day) + ", " + to_string(year);
